...
#     def chiper(self):
#         self._print('Welcome to Ceaser Chiper')
#         main = self._input('Wanna crypt your message? Please type y to start Ceaser Chipper: ')
#         if main.lower() in self._validation_start:
#             self._print('Great!')
#             pin = self._input('Please type the message that should be ecrypted: ')
#             print('Your encrypted message: ' , encrypted_pin)
#         else:
